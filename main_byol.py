...
parser = argparse.ArgumentParser(description='PyTorch Customer Training')
...
parser.add_argument('--checkpoint', default='./checkpoint-byol',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = byol.builder.BYOL(
        ...
        args.dim, args.pred_dim, args.momentum_decay)
    ...
    train_dataset = CategoryDataset(
        train_file,
        byol.transforms.TwoCropsTransform(transforms.Compose(augmentation)))
